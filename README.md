...
* 特性：脚本解锁`CHATGPT和Gemini以及claud`[点击查看解锁域名](https://github.com/kakakakaka1/dnsmasq_sniproxy_install/blob/master/proxy-domains.txt)，如需解锁其他流媒体请编辑文件`/etc/dnsmasq.d/custom_netflix.conf`和`/etc/sniproxy.conf`
